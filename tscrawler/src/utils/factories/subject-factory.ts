...
class SubjectFactory {
     ...
     * @returns 
     */
    static async createSubjectFromUrlString(url: string, depth: number, add_information: unknown, parent?: number, worker_id?: number, session?: Session, rank?: number): Promise<Subject | null> {
        ...
        try {
            ...
            const urlInDb = await URLFactory.createUrlFromString(url, depth, parent, session, t, rank);
